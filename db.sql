...
ALTER TABLE proverbs ADD COLUMN hit INT UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE proverbs ADD COLUMN likeIt INT UNSIGNED NOT NULL DEFAULT 0;
ALTER TABLE proverbs ADD COLUMN hateIt INT UNSIGNED NOT NULL DEFAULT 0;
